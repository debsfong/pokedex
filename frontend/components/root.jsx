...
const Root = ({ store }) => {
  ...
  const requestOnEnter = ( newState ) => {
    store.dispatch(requestPokemon(newState.params.id));
  };

  return (
    <Provider store={store}>
      <Router history={hashHistory}>
        <Route path="/" component={PokemonIndexContainer} onEnter={requestAllOnEnter}>
          <IndexRoute component={PokemonFormContainer} />
          <Route path="pokemon/:id" component={PokemonDetailContainer} onEnter={requestOnEnter}>
